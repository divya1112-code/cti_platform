...
def download_report():
    ...
    filename = generate_report(ioc, ioc_type, vt_score, abuse_score, otx_score, final_score, verdict)
...
def dashboard_data():
    ...
    cursor.execute("SELECT ioc, ioc_type, final_score, verdict, checked_at FROM ioc_results ORDER BY id DESC LIMIT 5")
    ...
    return jsonify({
        ...
        "recent": [{"ioc": r[0], "type": r[1], "score": r[2], "verdict": r[3], "time": r[4]} for r in recent]
    })
